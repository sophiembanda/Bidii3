...
const HistoryTable = () => {
  ...
  const filterData = (filter) => {
    ...
    if (filter === "performance") {
      ...
      axios
        .get("http://localhost:5000/query_advance_summary", {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        })
      ...
      const performanceRequest = axios.get("http://localhost:5000/histories", {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });

      const advanceRequest = axios.get("http://localhost:5000/query_advance_summary", {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
